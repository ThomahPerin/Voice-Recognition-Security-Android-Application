...
public class AddNewData extends BottomSheetDialogFragment {
    ...
    public static AddNewData newInstance(){
        return new AddNewData();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.new_databox, container, false);
        ...
        newTaskSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(finalIsUpdate){
                    ...
                    StorageModel task = new StorageModel();
                    task.setTask(text);
                    task.setStatus(0);
                    db.insertTask(task);
                }
